...
![Yazıtipi
Biçemleri](images/yazitipi7.png)
...
[Çıktı](https://github.com/acarzfr/latex-dersleri/blob/main/examples/ex3.pdf)
...
Bildirimler](images/yazitipi8.png)
...
![Yazıtipleri Mutlak
Boyutları](images/yazitipi9.png)
...
renkler](images/renkler.png)

Bunlar da yeterli gelmiyorsa seçeneklere bir de `svgnames` yazın ve
[buradaki](https://www.latextemplates.com/svgnames-colors){rel="noreferrer noopener"
target="_blank"} yüzden fazla rengi kullanılabilir duruma getirin.
...
| Model | Açıklama |
| :--- | :--- |
| gray | Grinin tonları (0-1). 0 (siyah), 1 (beyaz). Yani 0.95 çok açk gri, 0.30 koyu gri olur. |
| rgb | Red, Green, Blue (0-1). Üç renk (kurmızl, yeșil, mavi) 0 ile 1 arasında bir sayryla temsil edilir. |
| RGB | Red, Green, Blue (0-255). Üç renk (karmız1, yeșil, mavi) 0 ile 255 arasında bir sayıyla temsil edilir. |
