...
```
[Çıktı](https://github.com/acarzfr/latex-dersleri/blob/main/examples/ex2.pdf)
...
ilerleyen yazılarda değinilecektir ancak dileyen okur [@Oetiker, s. 13-14]'e bakabilir.


## Belge Sınıfları ve Seçenekleri {#belgesinifi}

Bölüm \@ref(tipik)'de  `\documentclass` komutunun zorunlu değişkeninin belge
...
``` {r eval=FALSE}
\documentclass[a5paper,11pt,twocolumn]{book}
```
...
## Türkçe Dil Ayarları ve Çoklu Dil Kullanımı {#turkce}
...
> Yakın zamana kadar ö, ş, ç,... gibi Türkçe karakterlerin
...
| :--- | :--- | :--- |
| `\part{...}` | -1( book ve report ) o ( article) | letter hariç |
...
> kullanılabilir elbette. Ancak `thebibliography` ortamının
...
LaTeX'de varsayılan kağıt boyutunun `letterpaper` olduğunu Bölün \@ref(belgesinifi)'de ifade etmiştik. Ayrıca aynı yazıda başka bir kağıt boyutunun
...
``` {r eval=FALSE}
\usepackage[paperwidth=175mm,paperheight=255mm,top=2cm,bottom=2cm,left=2.5cm,right=2.5cm]{geometry}
```
...
## Paragraflar ve Cümle Sonları

Boş bir satırın yeni bir paragraf açtığını Bölüm \@ref(bosluk)'de belirtmiştik. Aynı şey, `\par` komutuyla da yapılabilir.
...
LaTeX'de varsayılan olarak `\chapter` ve `\section` gibi bölümleme
komutlarından sonra oluşturulan ilk paragraf girintisiz, sonrakiler
girintili olur. Bu, paragraf başlarında `\indent` ya da `\noindent`
...
## Metni Hizalamak ve Sütunlara Bölmek
...
komutunun seçeneğine `twocolumn` yazılabileceğinden Bölüm \@ref(belgesinifi)'de bahsettik. Bu, tüm belgenin iki sütun dizilmesini sağlar. Bazı
...
> `\usepackage{color}` komutuyla `color` paketinin eklenmesi gerekir.
...
\begin{multicols}{2}
[\section{Başlık}
Burası sütunlara bölünmez.]
Burası sütunlara bölünür.
\end{multicols}
```
...
[enumitem](http://ftp.cc.uoc.gr/mirrors/CTAN/macros/latex/contrib/enumitem/enumitem.pdf) paketi vardır. Bu paketi kullanarak yapılabilecek
...
dışındadır, ancak sadece şunu belirtelim ki kodlama işini LaTeX'de Bölüm \@ref(turkce)'de bahsettiğimiz `fontenc` paketi üstlenir. Bu paketi belgenize eklemiş
...
![Roman
Yazıtipleri](images/yazitipi2.png)



![Sans Serif
Yazıtipleri](images/yazitipi3.png)



![Typewriter Yazıtipleri\
](images/yazitipi4.png)


![Elyazısı](images/yazitipi5.png)
...
::: wp-block-image
![Yazıtipi
Biçemleri](https://www.texdizgi.com/wp-content/uploads/2020/04/2020-04-26-19_24_54-Window.png){.wp-image-2423
loading="lazy" width="564" height="289"
srcset="https://www.texdizgi.com/wp-content/uploads/2020/04/2020-04-26-19_24_54-Window.png 564w, https://www.texdizgi.com/wp-content/uploads/2020/04/2020-04-26-19_24_54-Window-300x154.png 300w"
...
::: {.wp-block-column .is-vertically-aligned-center}
[example-27\
](https://www.texdizgi.com/wp-content/uploads/2020/04/example-27.pdf){.pdfemb-viewer
...
::: {.wp-block-column .is-vertically-aligned-center}
[example-28\
](https://www.texdizgi.com/wp-content/uploads/2020/04/example-28.pdf){.pdfemb-viewer
style="" data-width="max" data-height="max" toolbar="bottom"
toolbar-fixed="off"}
:::
:::
...
::: {.wp-block-column .is-vertically-aligned-center}
[example-30\
](https://www.texdizgi.com/wp-content/uploads/2020/04/example-30.pdf){.pdfemb-viewer
style="" data-width="max" data-height="max" toolbar="bottom"
toolbar-fixed="off"}
:::
:::
...
::: {.wp-block-column .is-vertically-aligned-center}
[example-32\
](https://www.texdizgi.com/wp-content/uploads/2020/04/example-32.pdf){.pdfemb-viewer
style="" data-width="max" data-height="max" toolbar="bottom"
toolbar-fixed="off"}
:::
:::
...
::: {.wp-block-codemirror-blocks-code-block .code-block}
``` {.CodeMirror setting="{\"mode\":\"stex\",\"mime\":\"text/x-latex\",\"theme\":\"monokai\",\"lineNumbers\":false,\"styleActiveLine\":false,\"lineWrapping\":false,\"readOnly\":false,\"language\":\"LaTeX\",\"modeName\":\"stex\"}"}
Altı \underline{çizili} 
kelimeler satır aralığını
bozar. İyisi mi altını çizmeyin.
```
:::
:::
...
::: {.wp-block-column .is-vertically-aligned-center}
[example-33\
](https://www.texdizgi.com/wp-content/uploads/2020/04/example-33.pdf){.pdfemb-viewer
style="" data-width="max" data-height="max" toolbar="bottom"
toolbar-fixed="off"}
:::
:::
...
Bildirimler](https://www.texdizgi.com/wp-content/uploads/2020/04/2020-04-26-19_38_48-Window-1.png){.wp-image-2440
loading="lazy" width="337" height="387"
srcset="https://www.texdizgi.com/wp-content/uploads/2020/04/2020-04-26-19_38_48-Window-1.png 337w, https://www.texdizgi.com/wp-content/uploads/2020/04/2020-04-26-19_38_48-Window-1-261x300.png 261w"
...
::: {.wp-block-column .is-vertically-aligned-center}
[example-34\
](https://www.texdizgi.com/wp-content/uploads/2020/04/example-34.pdf){.pdfemb-viewer
style="" data-width="max" data-height="max" toolbar="bottom"
toolbar-fixed="off"}
:::
:::
...
::: {.wp-block-column .is-vertically-aligned-center}
[example-36\
](https://www.texdizgi.com/wp-content/uploads/2020/04/example-36.pdf){.pdfemb-viewer
style="" data-width="max" data-height="max" toolbar="bottom"
toolbar-fixed="off"}
:::
:::
...
::: {.wp-block-column .is-vertically-aligned-center}
[example-38\
](https://www.texdizgi.com/wp-content/uploads/2020/04/example-38.pdf){.pdfemb-viewer
style="" data-width="max" data-height="max" toolbar="bottom"
toolbar-fixed="off"}
:::
:::
...
::: wp-block-image
![Yazıtipleri Mutlak
Boyutları](https://www.texdizgi.com/wp-content/uploads/2020/04/2020-04-26-19_48_34-Window.png){.wp-image-2451
loading="lazy" width="674" height="334"
srcset="https://www.texdizgi.com/wp-content/uploads/2020/04/2020-04-26-19_48_34-Window.png 674w, https://www.texdizgi.com/wp-content/uploads/2020/04/2020-04-26-19_48_34-Window-300x149.png 300w"
...
::: {.wp-block-column .is-vertically-aligned-center}
[example-39\
](https://www.texdizgi.com/wp-content/uploads/2020/04/example-39.pdf){.pdfemb-viewer
style="" data-width="max" data-height="max" toolbar="bottom"
toolbar-fixed="off"}
:::
:::
