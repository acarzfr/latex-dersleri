...
Table: (\#tab:belgesin) LaTeX'de Belge Sınıfları
...
seçenekler Tablo \@ref(tab:belgesec)'de gösterilmiştir.

Table: (\#tab:belgesec) LaTeX'de Belge Seçenekleri
...
Table: (\#tab:bolsev) LaTeX'de Bölüm Seviyeleri
...
düzenlenmesi](images/dizin.png){width=50%}
...
Aralık bırakırken kullanabileceğimiz ölçü birimleri Tablo \@ref(tab:olcubir)'de
gösterilmiştir.

Table: (\#tab:olcubir) LaTeX'de Ölçü Birimleri
...
![Yazıtipi Aileleri](images/yazitipi.png){width=50%}
...
renkler](images/renkler.png){width=100%}
