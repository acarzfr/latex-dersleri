...
```latex
\cite{<anahtar1>,<anahtar2>,<anahtar3>}
```
...
```{r fig-google, echo=FALSE, fig.show="hold", out.width="33%", fig.align='center', fig.cap = "Google Akademikten alıntı yapma", fig.ext = 'png'}
knitr::include_graphics("images/galinti1.png")
knitr::include_graphics("images/galinti2.png")
knitr::include_graphics("images/galinti3.png")
```
...
![](images/tex-studio.png){width=60%, align="center"}
...
Bilimsel bir yapıtta bulunması gereken *dizin* ya da diğer adıyla
*indeks*, bir yapıtın kişi, konu, yer adı vb. bakımından içindekileri
