...
{<gövde yazı tipi>}% teorem gövdesinde kullanılacak yazı tipi. Örn:\normalfont, \itshape...
{<girinti>}% Paragraf girintisi ölçüsü. Örn:0pt
{<başlık yazı tipi>}% teorem başlık yazı tipi.Örn:\sffamily,\bfseries
{<noktalama>}% başlıktan sonraki noktalama. Noktalama istenmezse boşluk bırakılabilir. Örn:\; 
...
Dokuzuncu satırdaki `<manuel başlık>` değişkeni `\thmname`, `\thmnumber`
