...
Kullanılabilecek tüm gruplandırıcı işaretler Tablo \@ref(tab:grup)'de
gösterilmiştir.

Table: (\#tab:grup) Gruplandırıcılar
...
Table: (\#tab:yunan) Yunan Harfleri
...
Table: (\#tab:matyazi) Matematik  Kipinde Yazı Biçemleri
...
Table: (\#tab:teorem) Teorem Stilleri
